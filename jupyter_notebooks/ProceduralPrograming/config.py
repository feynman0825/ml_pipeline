...
FREQUENT_LABELS = {
    ...
    'Neighborhood': [
        'Blmngtn', 'BrDale', 'BrkSide', 'ClearCr', 'CollgCr', 'Crawfor',
...
CATEGORICAL_TO_IMPUTE = [
    'MasVnrType', 'BsmtQual', 'BsmtExposure', 'FireplaceQu', 'GarageType',
    'GarageFinish'
]
...
FEATURES = [
    ...
    'KitchenQual', 'Fireplaces', 'FireplaceQu', 'GarageType', 'GarageFinish',
